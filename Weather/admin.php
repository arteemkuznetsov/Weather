...
<head>
    <meta charset="UTF-8">
    <title>Weather Info Portal – Администратор</title>
    <link href="css/account.css" rel="stylesheet">
    <link href="css/footer.css" rel="stylesheet">
    <script src="js-scripts/admin-actions.js"></script>
...
<div class="container">
            ...
            <td>
                <div>
                    <table>
                        <tr>
                            <td colspan="2">
                                <span style="font-weight: 600">Администратор</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
    ...
    <section style="display: flex; justify-content: space-between; margin-top: 15px" class="block">
        <table class="table-form">
            <tr>
                <td>
                    <div>
                        <table class="table-change">
                            <tr>
                                <td>
                                    <span style="font-weight: 600">Удалить пользователя</span>
                                </td>
                            </tr>
                            <tr class="custom-row">
                                <td>
                                    <span class="row-name">По идентификатору или логину:</span>
                                </td>
                                <td>
                                    <input type="text" id="user" pattern="[a-zA-Z0-9]{1,50}">
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="text-align: center">
                                    <button class="popup"><span onclick="deleteUser()">Удалить</span>
                                        <span class="popuptext" id="popup" onclick=""></span>
                                    </button>
                                </td>
                            </tr>
                        </table>
